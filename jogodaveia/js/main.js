...
function verifica() {
	...
	if(c1 != '' && c2 != '' && c3 != '' &&
	   ...
	   c1 != '' && c4 != '' && c7 != '' &&
	   c1 == c4 && c4 == c7 || //testando a primeira coluna
	   ...
	   c1 != '' && c5 != '' && c9 != '' &&
	   c1 == c5 && c5 == c9 || //testando a primeira diagonal

	   c3 != '' && c5 != '' && c7 != '' && //testando a segunda diagonal
	   c3 == c5 && c5 == c7) {
		alert('Você Ganhou!');
		novos();
	}
	...
	function novo() {
		for(let i = 1; i <= 9; 1++) {
			let celula = 'cel'
			document.getElementById('cel' + 1).innerHTML = ''
		}
	}